...
const SolarCalculator = () => {
  ...
  // Calculation helpers
  const calculateRecommendedSize = (monthlyBill: number, location: string, roofType: string): number => {
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900">Solar Savings Calculator</h1>
          ...
          <div className="p-8">
            {!showResults ? (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Sloped (South Facing)">Sloped Roof (South Facing)</option>
                    <option value="Sloped (East/West Facing)">Sloped Roof (East/West Facing)</option>
                    <option value="Sloped (North Facing)">Sloped Roof (North Facing)</option>
                  </select>
                </div>
              ...
              <div className="space-y-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Your Solar Power Estimate</h2>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-blue-50 rounded-lg p-6">
                    <div className="flex items-center mb-4">
                      <Sun className="h-8 w-8 text-blue-600 mr-3" />
                      <h3 className="font-semibold text-gray-900">Recommended System</h3>
                    </div>
                    <p className="text-3xl font-bold text-blue-600">{results.recommendedSize} kW</p>
                    <p className="text-sm text-gray-600 mt-2">System size based on your requirements</p>
                  </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-6">
                    ...
                    <p className="text-3xl font-bold text-green-600">₹{results.estimatedCost.toLocaleString()}</p>
                    <p className="text-sm text-gray-600 mt-2">Before any applicable subsidies</p>
                  </div>
                  ...
                  <div className="bg-yellow-50 rounded-lg p-6">
                    ...
                    <p className="text-3xl font-bold text-yellow-600">₹{results.annualSavings.toLocaleString()}</p>
                    <p className="text-sm text-gray-600 mt-2">Savings on electricity bills</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-purple-50 rounded-lg p-6">
                    ...
                    <p className="text-3xl font-bold text-purple-600">{results.roiYears} years</p>
                    <p className="text-sm text-gray-600 mt-2">Return on investment timeframe</p>
                  </div>
                  
                  <div className="bg-teal-50 rounded-lg p-6">
                    <div className="flex items-center mb-4">
                      <Activity className="h-8 w-8 text-teal-600 mr-3" />
                      <h3 className="font-semibold text-gray-900">CO₂ Reduction</h3>
                    </div>
                    <p className="text-3xl font-bold text-teal-600">{results.co2Reduction} tonnes/year</p>
                    <p className="text-sm text-gray-600 mt-2">Environmental impact</p>
                  </div>
                  
                  <div className="bg-red-50 rounded-lg p-6">
                    <div className="flex items-center mb-4">
                      <Calendar className="h-8 w-8 text-red-600 mr-3" />
                      <h3 className="font-semibold text-gray-900">25-Year Savings</h3>
                    </div>
                    <p className="text-3xl font-bold text-red-600">₹{results.lifetimeSavings.toLocaleString()}</p>
                    <p className="text-sm text-gray-600 mt-2">Lifetime system savings</p>
                  </div>
                </div>
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-8">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-lg text-gray-900">How accurate is this calculator?</h3>
                <p className="text-gray-600 mt-2">
                  This calculator provides estimates based on average solar conditions in your region and typical 
                  installation costs. Actual savings may vary based on specific site conditions, local electricity 
                  rates, and the final system configuration.
                </p>
              </div>
              
              <div>
                <h3 className="font-semibold text-lg text-gray-900">Are government subsidies included?</h3>
                <p className="text-gray-600 mt-2">
                  No, the estimated costs shown are before any applicable government subsidies or incentives. 
                  Depending on your location and eligibility, you may qualify for additional savings through 
                  various solar subsidy programs.
                </p>
              </div>
              
              <div>
                <h3 className="font-semibold text-lg text-gray-900">How much roof space do I need?</h3>
                <p className="text-gray-600 mt-2">
                  On average, you need about 10 square meters of roof space for every 1 kW of solar capacity. 
                  A typical 5 kW residential system would require approximately 50 square meters of unshaded 
                  roof area.
                </p>
              </div>
              
              <div>
                <h3 className="font-semibold text-lg text-gray-900">What maintenance is required?</h3>
                <p className="text-gray-600 mt-2">
                  Solar panels require minimal maintenance. Occasional cleaning to remove dust and debris, 
                  typically 2-4 times per year, is usually sufficient. The inverter may need replacement 
                  after 10-15 years, while the panels themselves typically last 25+ years.
                </p>
              </div>
            </div>
          </div>
